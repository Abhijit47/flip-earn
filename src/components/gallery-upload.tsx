...
import type { ScreenshotsProofValues } from '@/lib/validators/listing-schemas';
import {
  ImageIcon,
  TriangleAlert,
  Upload,
...
interface GalleryUploadProps {
  ...
  form?: UseFormReturn<ScreenshotsProofValues>;
}
